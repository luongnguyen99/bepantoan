    ...
    public function run()
    {
        ...
        DB::table('options')->insert([
            [
                'name' => 'logo',
                'key' => 'logo',
                'value' => 'http://localhost:8000/userfiles/images/logo-bepantoan.png',
            ],
            [
                'name' => 'footer',
                'key' => 'footer',
            ...
            [
                'name' => 'slide',
                'key' => 'slide',
                'value' => '[[{"type":null,"img_":"http:\/\/localhost:8000\/userfiles\/images\/dmestik.jpg"},{"type":null,"img_":"http:\/\/localhost:8000\/userfiles\/images\/CHEFS.jpg"},{"type":null,"img_":"http:\/\/localhost:8000\/userfiles\/images\/bosch(1).jpg"}]]',
            ],
            [
                'name' => 'email_admin',
                'key' => 'email_admin',
