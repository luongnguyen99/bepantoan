...
class OptionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $options = array(
            ...
            array('id' => '12','name' => 'menu','key' => 'menu','value' => '[{"clss":"","icon":"pe-7s-shopbag","name":"Sản phẩm","link":"http://luongnd2286.xyz/danh-muc"},{"clss":"","icon":"pe-7s-news-paper","name":"Tin tức","link":"http://luongnd2286.xyz/post/tin-tuc"},{"clss":"","icon":"pe-7s-tools","name":"Dịch vụ","link":"http://luongnd2286.xyz/post/tin-dich-vu"},{"clss":"km","icon":"pe-7s-gift","name":"Khuyến mãi","link":"https://luongnd2286.xyz/post/khuyen-mai"}]','created_at' => NULL,'updated_at' => '2019-12-05 16:35:07'),
            ...
            array('id' => '14','name' => 'sale','key' => 'sale','value' => '<p class="hotline">CHƯƠNG TRÌNH KHUYẾN MÃI</p>

            <p class="value">Giảm tới 10%</p>','created_at' => NULL,'updated_at' => '2019-12-06 08:40:11'),
            ...
            array('id' => '17','name' => 'sidebar','key' => 'sidebar','value' => '[{"text":"Cam k\\u1ebft gi\\u00e1 t\\u1ed1t nh\\u1ea5t","icon":"icon1.png"},{"icon":"icon2.png","text":"Nh\\u1eadn \\u0111\\u1ed5i tr\\u1ea3 trong 30 ng\\u00e0y"},{"icon":"icon3.png","text":"B\\u1ea3o tr\\u00ec tr\\u1ecdn \\u0111\\u1eddi"},{"icon":"icon4.png","text":"L\\u1eafp \\u0111\\u1eb7t mi\\u1ec5n ph\\u00ed t\\u1ea1i H\\u00e0 N\\u1ed9i"},{"icon":"icon5.png","text":"Giao h\\u00e0ng to\\u00e0n qu\\u1ed1c"},{"icon":"icon6.png","text":"Thanh to\\u00e1n khi nh\\u1eadn h\\u00e0ng"}]','created_at' => NULL,'updated_at' => '2019-12-06 08:49:30'),
            ...
            array('id' => '21','name' => 'categories_show_home','key' => 'categories_show_home','value' => '["17","19","20","32","38","39","41","42","46","47","51","31"]','created_at' => NULL,'updated_at' => '2019-12-05 17:49:48'),
            array('id' => '22','name' => 'Seo tiêu đề trang chủ','key' => 'seo_title_home','value' => '','created_at' => NULL,'updated_at' => '2019-12-05 09:30:18'),
            array('id' => '23','name' => 'Seo mô tả trang chủ','key' => 'seo_description_home','value' => '','created_at' => NULL,'updated_at' => '2019-12-05 09:30:18'),
            array('id' => '24','name' => 'Seo từ khóa trang chủ','key' => 'seo_keyword_home','value' => '','created_at' => NULL,'updated_at' => '2019-12-05 09:30:18'),
            array('id' => '25','name' => 'Chặn robot google trang chủ','key' => 'block_robot_google_home','value' => '0','created_at' => NULL,'updated_at' => '2019-12-05 09:30:18'),
            array('id' => '26','name' => 'Chặn robot google toàn trang','key' => 'block_robot_google','value' => '0','created_at' => NULL,'updated_at' => '2019-12-05 09:30:18')
            );
