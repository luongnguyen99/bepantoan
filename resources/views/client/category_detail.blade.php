	...
	<script>
		$('.lms-pagination.pagination').on('click',function() {
			...
			$.ajax({
				...
				beforeSend: function() {
					$('.lms-pagination.pagination').html('<a style="cursor:pointer" class="next">Loading ...</a>');
				},
				success:function(data){ 

					$('.lms-pagination.pagination').html('<a style="cursor:pointer" class="next"> Xem thêm <i class="fa fa-angle-right"></i></a>');
