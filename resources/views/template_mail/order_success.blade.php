                                        ...
                                        <tbody>
                                            <tr>
                                                <td bgcolor="#FFFFFF" style="padding:0" valign="top" width="100%">
                                                    <div style="color:#fff;background-color:f2f2f2;font-size:11px">Tổng giá
                                            ...
                                            <tr>
                                                <td>
                                                    <h1
                                                        ...
                                                        Cảm ơn quý khách {{$data['name_guest']}} đã đặt hàng,</h1>
    
                                                    <p
                                                        style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal">
                                                        Rất vui thông báo đơn hàng #{{$id_order}} của quý khách đã được
                                                        tiếp nhận và đang trong quá trình xử lý. Chúng tôi sẽ thông báo đến quý
                                                    ...
                                                    <h3
                                                        ...
                                                        Thông tin đơn hàng #{{$id_order}} <span
                                                            style="font-size:12px;color:#777;text-transform:none;font-weight:normal">({{$data['created_at']}})</span></h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2"
                                                                    ...
                                                                    <p
                                                                        style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal">
                                                                        <strong>Phương thức thanh toán: </strong> {{$data['method_payment'] ? 1 ==  'Thanh toán sau khi nhận hàng' : 'Chuyển khoản'}}
                                                                        <br>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                ...
                                                <td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tfoot
                                                            style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px">
                                                            <tr>
                                                                <td align="right" colspan="3" style="padding:5px 9px">Tạm
                                                                    tính</td>
                                                                <td align="right" style="padding:5px 9px">
                                                                    <span>{{pveser_numberformat($data['total'])}}</span></td>
                                                            </tr>
                                                            ...
                                                            <tr bgcolor="#eee">
                                                                ...
                                                                <td align="right" style="padding:7px 9px">
                                                                    <strong><big><span>{{pveser_numberformat($data['total'])}}</span> </big> </strong></td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
