...
{{-- page title --}}
@section('page_title')
Thêm giá trị thuộc tính {{$property->name}}
@endsection
...
<div class="row">
            ...
            <div class="box-body">
                ...
                <form id=create_>
                    ...
                    <div class="form-group">
                        <label for="name">Tên giá trị</label>
                    ...
                    <div class="form-group">
                        ...
                        <a class=" btn btn-danger" type="submit" href="{{route('admin.properties.index')}}">Hủy</a>
                    </div>
                </form>
    ...
    <div class="col-sm-6">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">
                    Giá trị thuộc tính {{$property->name}}
                </h3>
...
<script>
    ...
    $(function () {
        ...
        var table = $('#datatable').DataTable({
            ...
            stateSave: true,
            "ordering": false,
            ajax: `{{ route('admin.properties.data_value',['id' => Request::segment(3)]) }}`,
            // order: [
            //     [0, 'desc']
            // ],
            ...
            columns: [
                ...
                {data: null,title :'Tên giá trị',name : 'name', render: function ( data, type, row ) {
                    let step = '';   
                    return `
                    <div>${step + data.name}</div>
                    <div class="div-action"><a class="btn-edit"
                        href="{{ url('admin/properties/edit_value/') }}/${data.id}">Sửa</a>
    ...
    $('body').on('submit','#create_',function(e) {
        ...
        $.ajax({
            url: "{{route('admin.properties.saveAddValue',['id' => Request::segment(3)])}}",
            ...
            swal({
                ...
                if (willDelete) {
                    id = $(this).attr('data-id');
                             $.ajax({
                                url: `{{route('admin.properties.delete_value')}}`,
                                method: 'POST',
                                data: {
                                    _token: '{{csrf_token()}}',
                                    id : id,
