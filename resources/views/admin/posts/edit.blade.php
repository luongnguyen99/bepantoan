                    ...
                    <div class="seo_content"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="seo_title"
                                value="{{!empty($db->seo_title) ? $db->seo_title : ''}}" placeholder="Seo tiêu đề">
                        </div>
                        <div class="form-group">
                            <label for="seo_keyword">Từ khóa</label>
                            <input class="form-control" name="seo_keyword"
                                value="{{!empty($db->seo_keyword) ? $db->seo_keyword : ''}}" placeholder="Từ khóa">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label class="switch">
                                <input type="checkbox"
                                    {{!empty($db->block_robot_google) && $db->block_robot_google != -1 ? 'checked' : ''}}
