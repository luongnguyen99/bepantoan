                        ...
                        <div data-repeater-list="table[content]">
                            <div data-repeater-item>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12" style="margin-left:-15px">
                                        <div class="col-lg-9 col-md-9 col-sm-9">
                                            <input value="" type="text" name="type" class="form-control"
                                                id="exampleInputPassword4" placeholder="Đường dẫn">
                                        </div>
                                ...
                                <div class="alert alert-danger" style="opacity:0.5" role="alert">
                                    <strong>{{ $errors->first('img_') }}</strong>
                                </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    ...
                    <div style="position: relative;">
                        <a href="{{ $item['type'] }}">
                            ...
                            <a href="/admin/options/edit_slide/{{ $key }}" style="position: absolute; right:0;top:0"
                                href="" class="btn btn-warning">Sửa slide</a>
                            <a href="/admin/options/del_slide/{{ $key }}" style="position: absolute; left:0;top:0"
                                href="" class="btn btn-danger">Xóa slide</a>
                        </a>
